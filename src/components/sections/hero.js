...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Ahmed Shaban.</h2>;
  const three = <h3 className="big-heading">I build things for the web.</h3>;
  const four = (
    <>
      <p>
      I'm always seeking opportunities that would help me exceed myself. 
      I enjoy being the bridge between engineering and design and feel right
